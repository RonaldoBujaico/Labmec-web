...
const products = [
    {
        ...
        category: "Inspección",
        description:
            "Equipo ideal para inspección térmica, detección de puntos calientes y mantenimiento predictivo.",
        specs: ["-20 °C a 250 °C", "Inspección térmica", "Mantenimiento"],
        image:
    ...
    },
    {
        ...
        description:
            "Equipo para pruebas técnicas especializadas y evaluación en campo según requerimiento.",
        specs: ["Auto rango", "Lectura precisa", "Trabajo técnico"],
        image:
    ...
    },
    {
        ...
        description:
            "Equipo para medición de puesta a tierra y verificación de seguridad eléctrica.",
        specs: ["Puesta a tierra", "Campo", "Seguridad eléctrica"],
        image:
    ...
    },
    {
        ...
        category: "Medición eléctrica",
        description:
            "Instrumento para pruebas de aislamiento en mantenimiento industrial y diagnóstico.",
        specs: ["50V a 1000V", "Aislamiento", "Portátil"],
        image:
    ...
    },
    {
        ...
        description:
            "Equipo para monitoreo, análisis y registro de parámetros eléctricos en instalaciones.",
        specs: ["Calidad de energía", "Análisis", "Redes eléctricas"],
        image:
    ...
    },
    {
        ...
        category: "Medición eléctrica",
        description:
            "Equipo para medición de corriente, tensión y verificación de sistemas eléctricos.",
        specs: ["Hasta 1000A", "CA / CC", "Trabajo en campo"],
        image:
                ...
                <section className="relative overflow-hidden bg-[#231F20] px-5 py-20 text-white lg:px-8">
                    <div className="absolute inset-0">
                        <img
                            ...
                            alt="Alquiler de equipos técnicos"
                    ...
                    <div className="relative mx-auto max-w-7xl">
                        <div className="max-w-3xl">
                            ...
                            <p className="mt-6 text-lg leading-relaxed text-white/80">
                                Contamos con equipos disponibles para alquiler temporal en trabajos de
                                mantenimiento, verificación, inspección y diagnóstico técnico.
                            </p>
                        ...
                        <div className="mb-10 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                            <div>
                                ...
                                <p className="mt-3 max-w-2xl text-gray-600">
                                    Consulta disponibilidad, tiempo de alquiler y equipo adecuado según tu
                                    servicio o proyecto.
                                </p>
                            </div>
                            ...
                            {products.map((product) => (
                                ...
                                >
                                    <div className="relative h-60 overflow-hidden bg-white">
                                        ...
                                        <div className="absolute left-4 top-4 rounded-full bg-[#FFDD55] px-3 py-1 text-xs font-bold uppercase text-[#231F20]">
                                            Alquiler
                                        </div>
                    ...
                    <div className="mx-auto grid max-w-7xl gap-8 rounded-2xl bg-[#231F20] p-8 text-white md:grid-cols-[1fr_auto] md:items-center md:p-10">
                        <div>
                            ...
                            <p className="mt-3 max-w-2xl text-white/75">
                                Escríbenos y te ayudamos a elegir el equipo correcto según el trabajo,
                                tiempo de alquiler y disponibilidad.
                            </p>
                        </div>
