                    ...
                    <div className="mx-auto max-w-7xl">
                        ...
                        <div className="mt-12 grid gap-7 lg:grid-cols-2">
                            {maintenanceTypes.map((type) => (
                                <FadeInOnScroll key={type.title}>
                                    <article className="h-full rounded-2xl border border-gray-100 bg-white p-8 shadow-sm transition hover:-translate-y-2 hover:shadow-xl flex flex-col justify-between">
                                        <div>
                                        ...
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noreferrer"
                                            className="mt-7 inline-block rounded-md border border-[#ED7D31] px-6 py-3 font-semibold text-[#ED7D31] text-center transition hover:bg-[#ED7D31] hover:text-white"
                                        >
                            ...
                            <div className="grid gap-5 sm:grid-cols-2">
                                {benefits.map((benefit, index) => (
                                    <FadeInOnScroll key={benefit.title}>
                                        <article className="h-full rounded-xl bg-[#F7F7F7] p-6 transition hover:-translate-y-1 hover:bg-white hover:shadow-xl">
