...
const calibrationAreas = [
    ...
    {
        icon: "📡",
        title: "Laboratorio de equipos topográficos y geodésicos",
        description:
            "Verificación de equipos utilizados en medición, levantamiento, nivelación y control topográfico.",
        equipment: [
            "Niveles",
            "Teodolitos",
            "Estaciones totales",
    ...
    },
    {
        ...
        title: "Mapeo térmico",
        description:
            "Evaluación de distribución térmica en ambientes, cámaras, almacenes y espacios controlados.",
        equipment: [
    ...
    },
    {
        ...
        description:
            "Servicios técnicos para equipos de laboratorio usados en análisis y control de parámetros.",
        equipment: [
            "pH-metros",
            "Conductímetros",
            "Refractómetros",
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <span
                                                className={`text-2xl font-bold text-white transition-transform duration-300 ${isOpen ? "rotate-180" : ""
                                                    }`}
                                            >
                                                ⌄
                                            </span>
                    ...
                    <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
                        <div>
                            ...
                            <p className="mt-5 text-lg leading-relaxed text-gray-600">
                                Seguimos un proceso simple para identificar el requerimiento,
                                evaluar el instrumento y brindar una respuesta técnica adecuada.
                            </p>
                        ...
                        <div className="grid gap-5 sm:grid-cols-2">
                            {process.map((item) => (
                                <article
                                    key={item.step}
                                    className="rounded-xl bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-xl"
                                >
                    ...
                    <div className="mx-auto grid max-w-7xl gap-8 rounded-2xl bg-[#231F20] p-8 text-white md:grid-cols-[1fr_auto] md:items-center md:p-10">
                        <div>
                            ...
                            <p className="mt-3 max-w-2xl text-white/75">
                                Envíanos el nombre del equipo, marca, modelo y servicio requerido para
                                ayudarte con una cotización.
                            </p>
                        </div>
