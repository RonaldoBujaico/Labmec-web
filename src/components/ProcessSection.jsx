    ...
    return (
        <section className="bg-[#F7F7F7] px-5 py-20 lg:px-8">
            <div className="mx-auto max-w-7xl">
                ...
                {/* Pasos ordenados con entrada en cascada */}
                <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                    {steps.map((step, index) => (
                        <FadeInOnScroll key={step.number} direction="up" delay={index * 0.12}>
                            <article className="h-full rounded-xl bg-white p-7 shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
